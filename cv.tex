...
\documentclass[a4paper, margin, oneside]{res}
...
% Again, the contact lines must be centered over entire width of resume:
...
tooling. I am passionate about designing and building systems that compose well and
currently I am in charge of an internal enablement team developing systems to support
and accelerate engineering teams at Anaplan.
...
\section{SKILLS}
Software architecture, API design, back-end web services,
developer documentation. \\
Rust, Go, Python, Posix Shell,
SQL, Groovy, GraphQL, AWS, Docker, Kubernetes, Jenkins.
